...
import { useDispatch, useSelector } from "react-redux";  // Import useSelector to get the user role
...
function ExerciseNavbar() {
  ...
  const settings = role === "ADMIN" ? ["BackOffice", "Account", "Login", "Logout"] : ["Account", "Login", "Logout"];
